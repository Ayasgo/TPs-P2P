...
\begin{titlepage}
    ...
    \includegraphics[width=0.4\textwidth]{logo_inpt.png} 
    ...
    \textbf{Réalisé par :}\\
    Votre NOM Prénom\\[2cm]
    
    \textbf{Encadré par :}\\
    Nom du Professeur\\[2cm]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{code_mongo.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{code_routes.png}
    \caption{Implémentation des routes Express (Login, Upload, Find)}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{mean_arch.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{uml_usecase.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{uml_sequence.png}
