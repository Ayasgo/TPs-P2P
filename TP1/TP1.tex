...
\begin{titlepage}
    ...
    \includegraphics[width=0.4\textwidth]{logo_inpt.png} % Remplacez par le logo de l'INPT si vous l'avez, sinon commentez cette ligne
...
% EXTENSION 1
%===========================================================
\section{Refaire l’application développée précédemment en utilisant une base de données MySQL pour stocker et consulter les gains de la loterie des utilisateurs en se basant sur la technologie JDBC}
...
% EXTENSION 2
%===========================================================
\section{Refaire l’application pour empêcher un utilisateur d’accéder aux services de l’application si l’utilisateur ne possède pas le rôle "tomcat"}
